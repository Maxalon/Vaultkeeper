...
const PendingRelocationList = defineAsyncComponent(() => import('../pending/PendingRelocationList.vue'))
...
export const tabRegistry = {
  ...
  pending:      {
    component: markRaw(PendingRelocationList),
    // Per-deck Pending tab — scope the list to copies that came from
