...
class BulkSyncOracleTableTest extends TestCase
{
    ...
    // The legacy "back-fill NULL parsed-type columns from type_line" test
    // was retired with issue #33: type_line + supertypes/types/subtypes
    // no longer live on scryfall_cards at all. Parsing now happens once
    // in applyBulkCardData() and the result is written authoritatively
    // to scryfall_oracles during the per-card pass.
}
